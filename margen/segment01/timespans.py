...
alternations = [[1, 0]]*8 + [[0, 0]]

III_alternations = [[0, 11]] + [[1, 0]]*16 + [[0, 5]]
# print(III_alternations)
timespans = muda.alternating_timespans(
    alternations=alternations,
    denominator=1,
    annotations=["matA", "rests"]
    )
...
III_durations = III_timespans.annotated_durations(subdivision=(1, 4))
